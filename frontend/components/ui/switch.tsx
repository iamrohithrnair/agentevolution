...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ...
    className={cn(
      ...
      "transition-colors data-[state=checked]:bg-[var(--color-accent)] data-[state=unchecked]:bg-[var(--color-border-strong)]",
  ...
  >
    <SwitchPrimitive.Thumb
      className={cn(
        "pointer-events-none block h-4 w-4 rounded-full bg-white shadow-[var(--shadow-1)]",
